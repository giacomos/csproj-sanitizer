...
var parseStringAsync = util.promisify(parser.parseString);
var cwd = process.cwd();
exports.DEFAULT_FIND_PATTERN = '**/*.{cshtml,cs}';
exports.DEFAULT_FIND_IGNORE = '{node_modules,obj,bin}/**';
...
var findMissingIncludes = function (entries, findPattern, findIgnores) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                globAsync = util.promisify(glob);
                return [4 /*yield*/, globAsync(findPattern, { "ignore": findIgnores })];
            case 1:
                files = _a.sent();
                missingFiles = [];
                files.forEach(function (filePath) {
                    var relativePath = filePath.replace(path.join(cwd, "/"), "").split(path.sep).join('\\');
...
exports.csprojSanitizer = function (_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    findPattern = findPattern || exports.DEFAULT_FIND_PATTERN;
                    findIgnores = findIgnores || exports.DEFAULT_FIND_IGNORE;
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, readFileAsync(path.join(cwd, filePath), { encoding: 'utf-8' })];
                case 2:
                    data = _c.sent();
                    return [3 /*break*/, 4];
                case 3:
