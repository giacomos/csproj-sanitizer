...
var findMissingIncludes = function (entries, findPattern, findIgnores, rootDir) { return __awaiter(_this, void 0, void 0, function () {
    var globAsync, files, missingFiles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                globAsync = util_1.default.promisify(glob_1.default);
                return [4 /*yield*/, globAsync(path_1.default.join(rootDir, findPattern), { "ignore": findIgnores })];
            case 1:
                files = _a.sent();
                missingFiles = [];
                files.forEach(function (filePath) {
                    var relativePath = filePath.replace(path_1.default.join(rootDir, "/"), "").split(path_1.default.sep).join('\\');
...
exports.findStringLines = function (data, searchKeyword) {
...
var csprojSanitizer = function (_a) {
    var filePath = _a.filePath, findPattern = _a.findPattern, findIgnores = _a.findIgnores, rootDir = _a.rootDir;
    return __awaiter(_this, void 0, void 0, function () {
        var parsedData, results, _b, e_1, e_2, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    results = { data: "", includes: [], duplicates: [], missing: [] };
                    findPattern = findPattern || config_1.DEFAULT_FIND_PATTERN;
                    findIgnores = findIgnores || config_1.DEFAULT_FIND_IGNORE;
                    filePath = path_1.default.isAbsolute(filePath) ? filePath : path_1.default.join(rootDir, filePath);
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                    _b = results;
                ...
                case 4:
                    _d.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, parseStringAsync(results.data)];
                case 5:
                    parsedData = _d.sent();
                    return [3 /*break*/, 7];
                case 6:
                ...
                case 7:
                    ...
                    _c = results;
                    return [4 /*yield*/, findMissingIncludes(results.includes, findPattern, findIgnores, rootDir)];
                case 8:
                    _c.missing = _d.sent();
